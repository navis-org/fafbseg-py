...
# -*- coding: utf-8 -*-
#
# fafbseg documentation build configuration file, created by
...
html_theme_options = {
    ...
    'navbar_links': [("Install", "source/install"),
                     ...
                     ("API", "source/api"),
                     ("Github", "https://github.com/flyconnectome/fafbseg-py", True),
                     ],
                     }
...
latex_documents = [
    (master_doc, 'fafbseg.tex', 'fafbseg Documentation',
...
man_pages = [
    (master_doc, 'fafbseg', 'fafbseg Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'fafbseg', 'fafbseg Documentation',
     author, 'fafbseg', 'Neuron analysis toolbox.',
     'Miscellaneous'),
]
