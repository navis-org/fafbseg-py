...
1. `FlyWire <https://ngl.flywire.ai/>`_ by the Seung/Murthy labs
...
* map locations to neuron IDs
* transform neurons from FAFB/FlyWire space to other brains spaces (e.g. hemibrain) using `navis-flybrains <https://github.com/navis-org/navis-flybrains>`_)
* load meshes and skeletons for neuron meshes
